...
defaults = {1,50,1e-14};% Initial guess, max iterations, tolerance.
...
LGS = logspace(-1,2,520); % Can be altered for wider range or denser search.
LNS = 0:1/59:18/19;  % Search very close to initial guess too.
